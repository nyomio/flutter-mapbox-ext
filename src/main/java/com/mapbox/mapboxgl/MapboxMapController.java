...
import com.mapbox.mapboxgl.nyomio.components.CameraMethodsKt;
import com.mapbox.mapboxgl.nyomio.components.MapClickListenersKt;
import com.mapbox.mapboxgl.nyomio.components.MethodChannelEventsKt;
import com.mapbox.mapboxgl.nyomio.components.RouteMethodsKt;
import com.mapbox.mapboxgl.nyomio.components.TrackerMethodsKt;
import com.mapbox.mapboxgl.nyomio.model.LatLngMapNyomio;
import com.mapbox.mapboxgl.nyomio.model.LatLngNyomio;
import com.mapbox.mapboxgl.nyomio.model.ParseKt;
...
import static com.mapbox.mapboxgl.nyomio.components.MethodChannelEventsKt.mapInited;
...
public class MapboxMapController
  ...
  public List<Point> animatedCoordinates = new ArrayList<Point>();
  public ValueAnimator latLngAnimator = null;
  public List<LatLngMapNyomio> route = new ArrayList<>();
  public List<Feature> features = new ArrayList<>();
  public List<TrackerModel> trackers = new ArrayList<>();
  public Boolean isTrackerRemove = false;
  public FeatureCollection featureCollection = null;
  public List<PlaceModel> places = new ArrayList<>();
  ...
  public void onMapReady(MapboxMap mapboxMap) {
    ...
    if ( this.mapboxMap.getStyle() != null &&  this.mapboxMap.getStyle().getLayer("country-label") != null)
      Objects.requireNonNull(this.mapboxMap.getStyle().getLayer("country-label")).setProperties(PropertyFactory.textField("{name_hu}"));
    this.mapboxMap.addOnMapLongClickListener(MapClickListenersKt.onMapLongClick(this));
    this.mapboxMap.addOnMapClickListener(MapClickListenersKt.onMapClick(this));
    this.mapboxMap.setOnPolygonClickListener(MapClickListenersKt.onPolygonClick(this));
    MethodChannelEventsKt.mapInited(this);
    CameraMethodsKt.showCurrentPosition(this);
  ...
  public void onMethodCall(MethodCall call, MethodChannel.Result result) {
    switch (call.method) {
      ...
      case "line#addAnimatedLine": {
        final String list = call.argument("routeCoordinateList");
        if (list != null) {
          RouteMethodsKt.drawRoute(this,list);
        }
        result.success(list);
        break;
      }
