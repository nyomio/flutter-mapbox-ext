...
fun MapboxMapController.markerLongClick(featureList: List<Feature>){
    methodChannel?.invokeMethod("nyomio#mapMarkerLongClick", (featureList.first().getStringProperty(PROPERTY_ID) ?: "0").toInt())
}
...
fun MapboxMapController.alertLongClick(featureList: List<Feature>){
    methodChannel?.invokeMethod("nyomio#mapAlertLongClick", (featureList.first().getStringProperty(PROPERTY_ID) ?: "0").toInt())
}
...
fun MapboxMapController.mapLongClick(it: LatLng){
    methodChannel?.invokeMethod("nyomio#mapLongClick", Gson().toJson(LatLng(it.latitude, it.longitude)))
}
...
fun MapboxMapController.markerClick(featureList: List<Feature>){
    methodChannel?.invokeMethod("nyomio#mapMarkerClick", (featureList.first().getStringProperty(PROPERTY_ID) ?: "0").toInt())
}
...
fun MapboxMapController.alertClick(featureList: List<Feature>){
    methodChannel?.invokeMethod("nyomio#mapAlertClick", (featureList.first().getStringProperty(PROPERTY_ID) ?: "0").toInt())
}
