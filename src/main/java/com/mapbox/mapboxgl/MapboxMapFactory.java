...
public class MapboxMapFactory extends PlatformViewFactory {
  ...
  public PlatformView create(Context context, int id, Object args) {
    ...
    return builder.build(id, context, mActivityState, mPluginRegistrar,"pk.eyJ1IjoibmFneWlzdHZhbiIsImEiOiJjazV0cXg3bzYwbnZ4M3Bsb3hkbWpvc2p3In0.8xJrKqAblLpP0esoI4Qi1A");
  }
}
